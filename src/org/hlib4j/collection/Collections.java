 ...
 * (e.g: a filter with a complex filter algorithm). If the developer wants to clean its originalCollection for all
 ...
 * forbidden values will be deleted automatically an iterator will be used or a <code>toArray()</code> or
