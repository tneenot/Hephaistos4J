...
public class RangeTest
{
  ...
  @Test
  public void test_isInclude_BothOpen_ValueNotInclude() throws RangeException
  {
    // Setup
    Range<Integer> range = new Range<>(DefinitionDomain.LimitType.BOTH_OPEN, 0, 3, 2);

    // Assert
    Assert.assertFalse(range.isInclude(3));
  }
  ...
  @Test
  public void test_Constructor_OpenCloseNotSameLimits_CurrentValueIsEqualsToUpperLimitValue() throws RangeException
  {
    // Setup
    Range<Integer> range = new Range<>(DefinitionDomain.LimitType.OPEN_CLOSE, 0, 1);

    // Assert
    Assert.assertEquals(range.getCurrentValue(), range.getUpperLimitValue());
  }
